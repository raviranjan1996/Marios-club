...
<script type="text/javascript">
	...
	function showMessages(data) {
		...
		for(var i=0; i<data.messages.length; i++) {
			...
			subjectSpan.appendChild(document.createTextNode("Subject:-  " + message.subject));
			
			var contentSpan = document.createElement("span");
			contentSpan.setAttribute("class", "messagebody");
			contentSpan.appendChild(document.createTextNode("Content:-  " + message.content));
			
			var nameSpan = document.createElement("span");
			nameSpan.setAttribute("class", "name");
			nameSpan.appendChild(document.createTextNode("Name and Email:-  "  + message.name + " ("));
